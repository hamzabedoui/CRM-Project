              ...
              >
                {sales.map((sale) => (
                  <MenuItem key={sale._id} value={sale._id}>
                    {`${sale.customerId ? sale.customerId.name : "unknown customer"} - ${sale.totalAmount} - ${sale.serviceId.name}`}
                  </MenuItem>
                ))}
              </Select>
            </FormControl>
            {selectedSale && (
              <div>
                <Typography variant="body1">
                  Customer: {selectedSale.customerId.name? selectedSale.customerId.name : "******" }
                </Typography>
                <Typography variant="body1">
